...
def get_data(score, sequence):
    ...
    pl_cl = consts.LABEL_HYPO_RESISTANCE if float(score) < 0.5 else consts.LABEL_HYPO_PRONE
...
def plot_logomaker(seq_list):
    ...
    logo = lm.Logo(info_mat, stack_order='small_on_top')
...
def main():
    ...
    instances = get_instances(sequence_df, consts.LABEL_HYPO_RESISTANCE, minus_1_op=('C', 'G'),
                              plus_1_op=('C', 'G'))
