...
from classifier.utils import precision, recall, load_data_merged, f1_score
...
def test_model(output_path, data_path, res_path, model_name, input_len):
    ...
    model = load_model(os.path.join(res_path, model_name + ".h5"),
                       custom_objects={'precision': precision, 'recall': recall, "f1": f1_score})
